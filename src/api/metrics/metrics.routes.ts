...
import { renderAllPrometheusLines } from '../../shared/monitoring/metrics/index.js';
...
export function createMetricsRouter(): Router {
  ...
  router.get('/metrics', (req: Request, res: Response) => {
    ...
    const lines = [
      ...
      '# HELP pranidoctor_heap_used_bytes Heap used (legacy alias)',
