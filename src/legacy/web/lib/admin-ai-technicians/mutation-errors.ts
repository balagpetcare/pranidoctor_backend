...
export function technicianMutationErrorResponse(
  e: unknown,
): NextResponse | null {
  ...
  if (e instanceof Error) {
    switch (e.message) {
      ...
      case "INVALID_VILLAGE_IDS":
        return jsonError(
          "INVALID_VILLAGE_IDS",
          "One or more village IDs were not found",
          422,
        );
      ...
      case "CANNOT_ACTIVATE_REJECTED":
        return jsonError(
          "INVALID_STATE",
          "Cannot activate a rejected technician profile",
          422,
        );
      case "INVALID_FEE":
        return jsonError(
