...
import { adminReplaceServiceCategories } from "@/lib/admin-doctors/doctor-admin-service";
import { doctorMutationErrorResponse } from "@/lib/admin-doctors/mutation-errors";
import { serviceCategoriesBodySchema } from "@/lib/admin-doctors/schemas";
...
export async function PUT(request: Request, ctx: RouteCtx) {
  ...
  try {
    const doctor = await adminReplaceServiceCategories(
      id,
