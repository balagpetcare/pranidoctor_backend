...
/** Resolve customer user id for foundation logout (middleware or Bearer). */
export async function resolveFoundationLogoutUserId(req: Request): Promise<string | null> {
