...
export function configureAiAdminRoutes(router: Router, admin: AiAdminController): void {
  ...
  router.get('/analytics/usage/dashboard', ...guard, asyncHandler(admin.usageAnalyticsDashboard.bind(admin)));
  router.get('/analytics/usage/daily-cost', ...guard, asyncHandler(admin.usageDailyCost.bind(admin)));
  router.get('/analytics/usage/monthly-cost', ...guard, asyncHandler(admin.usageMonthlyCost.bind(admin)));
  router.get('/analytics/usage/providers', ...guard, asyncHandler(admin.usageProviderComparison.bind(admin)));
  router.get('/analytics/usage/features', ...guard, asyncHandler(admin.usageFeatureComparison.bind(admin)));
  router.get('/analytics/usage/trends', ...guard, asyncHandler(admin.usageCostTrends.bind(admin)));
  router.get('/analytics/usage/report', ...guard, asyncHandler(admin.usageReport.bind(admin)));
  ...
  router.get('/prompts/keys/:promptKey/versions', ...guard, asyncHandler(admin.listPromptVersions.bind(admin)));
  router.post('/prompts/keys/:promptKey/drafts', ...guard, asyncHandler(admin.createPromptDraftFromPublished.bind(admin)));
  router.get('/prompts/:id', ...guard, asyncHandler(admin.getPrompt.bind(admin)));
  router.put('/prompts/:id', ...guard, asyncHandler(admin.updatePrompt.bind(admin)));
  router.delete('/prompts/:id', ...guard, asyncHandler(admin.deletePromptDraft.bind(admin)));
  router.post('/prompts/:id/publish', ...guard, asyncHandler(admin.publishPrompt.bind(admin)));
  router.post('/prompts/:id/rollback', ...guard, asyncHandler(admin.rollbackPrompt.bind(admin)));
  ...
  router.get('/secrets', ...guard, asyncHandler(admin.listSecrets.bind(admin)));
  router.post('/secrets', ...guard, asyncHandler(admin.addSecret.bind(admin)));
  router.put('/secrets/:id', ...guard, asyncHandler(admin.updateSecret.bind(admin)));
  router.post('/secrets/:id/disable', ...guard, asyncHandler(admin.disableSecret.bind(admin)));
  router.post('/secrets/:id/test', ...guard, asyncHandler(admin.testSecret.bind(admin)));
  router.post('/secrets/:id/rotate', ...guard, asyncHandler(admin.rotateSecret.bind(admin)));
  router.get('/secrets/:id/audit', ...guard, asyncHandler(admin.listSecretAudit.bind(admin)));
}
